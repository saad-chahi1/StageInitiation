        ...
        <ul>
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-content">
                <a href="#">Systéme Bilingue & BIOF</a>
                <a href="#">CPGE & Université</a>
                <a href="#">Autres Systéme</a>
              </div>
            </li>
            <li><a href="#news">Cours de langues</a></li>
            <li><a href="{{ url('/nos-atelier') }}">Nos Ateliers</a></li>
            <li><a href="#news">Nos Formules</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="tele" class="col-md-4 col-form-label text-md-right">{{ __('téléphone') }}</label>
